...
BL_LILAC_RDD_ERROR_DTE rdd_data_structures_init ( RDD_INIT_PARAMS  *init_params )
{
    ...
    g_runner_extra_ddr_base_addr = init_params->ddr_fm_ptr;
    g_runner_extra_ddr_base_addr_phys = init_params->ddr_fm_phys;
    g_runner_tables_ptr = init_params->ddr_fm_ptr;
    ...
    f_rdd_bpm_initialize(init_params->ddr_bm_phys, 0, init_params->ddr_fm_phys);

    /* initialize runner dma base address */
    f_rdd_ddr_initialize(init_params->ddr_bm_phys, 0, g_ddr_headroom_size);
                                                   ...
                                                   uint32_t xi_ddr_headroom_size)
{
    ...
    runner_ddr_config_register.buffer_size = RDP_CFG_BUF_SIZE_2K;
...
static BL_LILAC_RDD_ERROR_DTE f_rdd_local_registers_initialize ( void )
{
    ...
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE0_THREAD_NUMBER ][ CS_R8  ] = ((DS_CONNECTION_BUFFER_TABLE_ADDRESS + 0 * RDD_DS_CONNECTION_BUFFER_TABLE_SIZE2 * sizeof(RDD_CONNECTION_ENTRY_DTS)) << 16) | (DS_FC_L2_UCAST_CONNECTION_BUFFER_ADDRESS + 0x0000);
    ...
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE1_THREAD_NUMBER ][ CS_R8  ] = ((DS_CONNECTION_BUFFER_TABLE_ADDRESS + 1 * RDD_DS_CONNECTION_BUFFER_TABLE_SIZE2 * sizeof(RDD_CONNECTION_ENTRY_DTS)) << 16) | (DS_FC_L2_UCAST_CONNECTION_BUFFER_ADDRESS + 0x0010);
    ...
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE2_THREAD_NUMBER ][ CS_R8  ] = ((DS_CONNECTION_BUFFER_TABLE_ADDRESS + 2 * RDD_DS_CONNECTION_BUFFER_TABLE_SIZE2 * sizeof(RDD_CONNECTION_ENTRY_DTS)) << 16) | (DS_FC_L2_UCAST_CONNECTION_BUFFER_ADDRESS + 0x0020);
    ...
    local_register[ DOWNSTREAM_FLOW_CACHE_SLAVE3_THREAD_NUMBER ][ CS_R8  ] = ((DS_CONNECTION_BUFFER_TABLE_ADDRESS + 3 * RDD_DS_CONNECTION_BUFFER_TABLE_SIZE2 * sizeof(RDD_CONNECTION_ENTRY_DTS)) << 16) | (DS_FC_L2_UCAST_CONNECTION_BUFFER_ADDRESS + 0x0030);
    ...
    local_register[ UPSTREAM_FLOW_CACHE_SLAVE0_THREAD_NUMBER - 32 ][ CS_R8  ] = (uint32_t) ((US_CONNECTION_BUFFER_TABLE_ADDRESS + 0 * RDD_US_CONNECTION_BUFFER_TABLE_SIZE2 * sizeof(RDD_CONNECTION_ENTRY_DTS)) << 16) | (US_FC_L2_UCAST_CONNECTION_BUFFER_ADDRESS + 0x0000);
    ...
    local_register[ UPSTREAM_FLOW_CACHE_SLAVE1_THREAD_NUMBER - 32 ][ CS_R8  ] = (uint32_t) ((US_CONNECTION_BUFFER_TABLE_ADDRESS + 1 * RDD_US_CONNECTION_BUFFER_TABLE_SIZE2 * sizeof(RDD_CONNECTION_ENTRY_DTS)) << 16) | (US_FC_L2_UCAST_CONNECTION_BUFFER_ADDRESS + 0x0010);
    ...
    local_register[ UPSTREAM_FLOW_CACHE_SLAVE2_THREAD_NUMBER - 32 ][ CS_R8  ] = (uint32_t) ((US_CONNECTION_BUFFER_TABLE_ADDRESS + 2 * RDD_US_CONNECTION_BUFFER_TABLE_SIZE2 * sizeof(RDD_CONNECTION_ENTRY_DTS)) << 16) | (US_FC_L2_UCAST_CONNECTION_BUFFER_ADDRESS + 0x0020);
    ...
    local_register[ UPSTREAM_FLOW_CACHE_SLAVE3_THREAD_NUMBER - 32 ][ CS_R8  ] = (uint32_t) ((US_CONNECTION_BUFFER_TABLE_ADDRESS + 3 * RDD_US_CONNECTION_BUFFER_TABLE_SIZE2 * sizeof(RDD_CONNECTION_ENTRY_DTS)) << 16) | (US_FC_L2_UCAST_CONNECTION_BUFFER_ADDRESS + 0x0030);
